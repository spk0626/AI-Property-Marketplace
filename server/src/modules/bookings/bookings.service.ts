...
import { BOOKING_QUEUE, EMAIL_JOBS } from '../../jobs/jobs.constants';
import type { BookingConfirmationJob } from '../../jobs/email.processor';
  ...
  async updateStatus(
    ...
    if (booking.property.ownerId !== ownerId) {
      throw new ForbiddenException(
        'You can only update bookings for your own properties',
      );
    }
