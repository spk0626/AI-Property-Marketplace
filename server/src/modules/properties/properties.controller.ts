...
export class PropertiesController {
  ...
  @Roles('OWNER', 'ADMIN')
  @UseInterceptors(
    // @Interceptors is used to handle file uploads
    FileInterceptor('image', {
      // FileInterceptor is configured to expect a single file with the field name 'image'
      ...
      fileFilter: (_req, file, cb) => {
        // fileFilter is a function that checks the MIME type of the uploaded file against a list of allowed types (JPEG, PNG, WEBP)
